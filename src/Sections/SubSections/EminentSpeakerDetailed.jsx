         ...
         {EminentSpeakerDetails.map(({ icon: Icon, text }, index) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-start gap-12 lg:mt-18 mt-10">
            ...
            <div className="flex flex-col gap-6">
              <h4 className="Counter_title archivo text-[24px] text-grey">Theme:</h4>
              <p className="Counter_title text-[32px] text-green font-semibold leading-[32px] w-full">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex mt-6 lg:mt-0 flex-col gap-4 lg:w-1/2">
                <h4 className="Counter_title archivo text-[24px]  text-grey">ABOUT SPEAKER:</h4>
                <h4 className="Counter_title text-[22px] text-green font-normal leading-[32px] ">Mr JONATHAN SAID</h4>
