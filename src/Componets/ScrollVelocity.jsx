  ...
  return (
    <ScrollVelocityContext.Provider value={velocityFactor}>
      <div className={`relative w-full overflow-hidden ${className}`} {...props}>
        ...
        {overlay && (
          <>
            <div className="absolute inset-y-0 left-0 z-10 w-1/5 pointer-events-none bg-gradient-to-r from-[#f8ffef] to-transparent"></div>
            <div className="absolute inset-y-0 right-0 z-10 w-1/4 pointer-events-none bg-gradient-to-l from-[#f8ffef] to-transparent"></div>
          </>
        )}
      </div>
